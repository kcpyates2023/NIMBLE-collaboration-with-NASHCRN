...
Table_Fun_Comparison<-function(FIT_Biomarker=FIT_Biomarker, FIT_Candidate=FIT_Candidate){
  ...
  CI_low_Biomarker<-AUCROC_Biomarker-qnorm(0.975)*SE_AUC_Biomarker
  CI_upper_Biomarker<-AUCROC_Biomarker+qnorm(0.975)*SE_AUC_Biomarker 
  ...
  CI_low_Candidate<-AUCROC_Candidate-qnorm(0.975)*SE_AUC_Candidate
  CI_upper_Candidate<-AUCROC_Candidate+qnorm(0.975)*SE_AUC_Candidate
  ...
  Tab_Biomarker_Total[["**"]]<-"**"
  Tab_Biomarker_Total[["Area Under the ROC Curve(95%CI)"]]<-paste0(format( round(AUCROC_Biomarker,3) ,nsmall=3),"(", format( round(CI_low_Biomarker,3), nsmall = 3),",",format( round(CI_upper_Biomarker,3), nsmall = 3),")")
  ...
  Tab_Biomarker_Positive[["**"]]<-"**"
  Tab_Biomarker_Positive[["Area Under the ROC Curve(95%CI)"]]<-"  "
  ...
  Tab_Biomarker_Negative[["**"]]<-"**"
  Tab_Biomarker_Negative[["Area Under the ROC Curve(95%CI)"]]<-"  "
  ...
  Tab_Candidate_Total[["**"]]<-"**"
  Tab_Candidate_Total[["Area Under the ROC Curve(95%CI)"]]<-paste0(format(round(AUCROC_Candidate,3),nsmall=3 ),"(", format( round(CI_low_Candidate,3), nsmall = 3),",",format( round(CI_upper_Candidate,3), nsmall = 3),")")
  ...
  Tab_Candidate_Positive[["**"]]<-"**"
  Tab_Candidate_Positive[["Area Under the ROC Curve(95%CI)"]]<-"  "
  ...
  Tab_Candidate_Negative[["**"]]<-"**"
  Tab_Candidate_Negative[["Area Under the ROC Curve(95%CI)"]]<-"  "
